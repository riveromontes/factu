...
if(isset($_POST["btn1"])){
	...
	if($btn=="Nuevo"){
					...
					$sql="SELECT max(codpro +1) from productos";
					$cs = mysql_query($sql,$conexion);
		...
		$sql="insert into productos values ('$cod','$nom','$dire','$tel','$date','$cate')";
		...
		$sql="update productos set descripcion='$nom',stock='$dire',precio='$tel',fecha='$date',categoria='$cate' where codpro ='$cod'";
		...
		$sql="delete from productos where codpro ='$cod'";
...
<div class="col-md-6 form-group">
    ...
    <input type="text" class="form-control" name="txtnom" id="txtnom" maxlength='50'  SIZE="50"value="<?php echo $var1?>" placeholder="ingrese aqui el nombre" >
 </div>
 
<div class="col-md-6 form-group">
<label >STOCK:</label>
<input type="text" class="form-control" name="txtdire" id="txtdire" value="<?php echo $var2?>" maxlength="9" placeholder="ingrese aqui el stock" >
</div>
...
<div class="col-md-6 form-group">
<label >PRECIO:</label>
<input type="text" class="form-control" name="txtcel"  id="txtcel"  value="<?php echo $var3?>" onKeyPress="keynumeros();" placeholder="ingrese aqui el precio">
 </div>
...
$conexion="SELECT nombrecat FROM categoria";
$res=@mysql_query($conexion);
if(!$res){
echo " fallo";
}
else{
echo "<select class='form-control' name='cbocat'  value='<?php echo $var5?>'>";
while ($fila=mysql_fetch_array($res)){
echo "<option>", $fila['nombrecat'], "</option>";
}
echo "</select>";
}
?>
